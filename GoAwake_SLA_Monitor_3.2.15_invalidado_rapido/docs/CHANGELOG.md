## 3.2.15
- Reduzida a espera entre o primeiro OK e o primeiro Finalizar.
- Busca de botões acelerada de 100 ms para 25 ms.
- O fluxo agora avança assim que o primeiro Finalizar fica visível, sem aguardar a animação do Alertify.
