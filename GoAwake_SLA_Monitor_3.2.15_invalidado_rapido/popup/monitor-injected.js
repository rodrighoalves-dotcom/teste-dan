  ...
  (function instalarAutomacaoAlertaInvalidado() {
    ...
    async function executarFluxo() {
      ...
      try {
        ...
        // Não aguardamos o botão OK desaparecer: o Alertify pode manter o nó
        // no DOM por alguns segundos durante a animação. A próxima etapa começa
        // assim que o botão Finalizar ficar visível.
